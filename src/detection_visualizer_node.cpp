...
: rclcpp::Node("DetectionVisualizerNode", options)
{
  ...
  sub_image_.subscribe(this, "image_raw", rclcpp::SensorDataQoS().get_rmw_qos_profile());
  sub_detections_.subscribe(this, "detections");

  //Publisher
  pub_image_ = this->create_publisher<sensor_msgs::msg::Image>("dbg_image", rclcpp::SensorDataQoS());
